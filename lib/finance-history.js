 ...
 * می‌کند منظورش روز تقویمی ایران است؛ با گروه‌بندی UTC، معامله‌های نیمه‌شب تا
 * ۳:۳۰ بامداد تهران به روز قبل می‌افتند (مرز روز UTC ساعت ۳:۳۰ تهران است). timestamp به‌صورت ISO با Z ذخیره شده، پس
