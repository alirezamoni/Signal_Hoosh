...
async function fetchFromApi() {
  // نام متغیر در .env و ecosystem.config.js «OPENROUTER_KEY» است، نه
  // OPENROUTER_API_KEY — پس این درخواست همیشه بدون احراز هویت می‌رفت و فهرست
  // عمومی را می‌گرفت، نه فهرستی که حساب خودِ ما می‌بیند.
